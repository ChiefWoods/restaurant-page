...
export function createMenu() {
  ...
  section.appendChild(createMenuGroup('APPETIZER', [
    createMenuItem('BBQ Buffalo Bites', 'Baked wings tossed in buffalo sauce, served along a side of celery sticks and blue cheese dip.'),
    createMenuItem('Carolina Hush Puppies', 'Deep friend cornbread, served with a miniature farmhouse coleslaw.')
  ]));

  section.appendChild(createMenuGroup('MEATS', [
    createMenuItem('Texas Barbecued Brisket', `What you are really here for. Smoked for 12 hours, this 1lb behemoth comes with our homemade BBQ dip for good measure.`),
    createMenuItem('Memphis Ribs', 'Pork ribs smoked over charcoal in a vinegar rub, finished with herbal and earthy seasoning.'),
    ...
    createMenuItem('Carolina Pulled Pork', 'Slow cooked juicy pork shoulder, shredded cabbage, layered between sesame buns.')
  ]))
  ...
  section.appendChild(createMenuGroup('DRINKS', [
    ...
    createMenuItem('Lemonade', 'Life gave us lemons, lots of lemons.')
  ]))
